...
//       formData.append("clientWebsite", e.target.clientWebsite.value); // ✅ FIXED

//       const res = await axios.post("/api/create-client", formData, {
...
//               <Input id="projectsDetails" name="projectsDetails" placeholder="Enter project details" />
//             </div>

//             <div>
//               <Label htmlFor="packageDetails">Package Details</Label>
//               <Input id="packageDetails" name="packageDetails" placeholder="Enter package details" />
//             </div>
